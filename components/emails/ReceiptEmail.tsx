...
import { formatter } from '../sections/products/currency'
...
interface ReceiptEmailProps {
  ...
  // products: OrderItem[]
  products: Array<OrderItem & { product: Product }>
}
...
export const ReceiptEmail = ({
  ...
  console.log("FFFFFFFFF", products)
  const total =
    products.reduce((acc, curr) => acc + curr.product.price, 0) + 1

  return (
    <Html>
      <Head />
      <Preview>Your LeospaBeauty Receipt</Preview>
        ...
        <Container style={container}>
          <Section>
            <Column>
              <Img
                // src="images/logo.png"
                src="https://utfs.io/f/7bd7f634-921c-4cef-ab72-32ad3094af86-1zbfv.png"
                width='60'
                height='60'
                alt='LeospaBeauty'
              />
          ...
          <Text style={footerCopyright}>
            Copyright © {new Date().getFullYear()} LeospaBeauty Inc. <br />{' '}
...
// convert the react-email libary to html elements users can understand
